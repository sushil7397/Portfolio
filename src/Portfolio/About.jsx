    ...
    <div className='MainSection' id='about'>
        ...
        <div className="Aboutsection">
            ...
            <div className="sidesection">
                ...
                <button className='buttonStyle' ><Link className='buttonLink' fileUrl={fileUrl} fileName={fileName} download onClick={handleDownload}>Download CV  <FontAwesomeIcon className='icon' icon={faFileAlt} /> </Link></button>
            </div>
        </div>
